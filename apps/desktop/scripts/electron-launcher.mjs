// This file mostly exists because we want dev mode to say "Meridian Code (Dev)" instead of "electron"
...
const APP_DISPLAY_NAME = isDevelopment ? "Meridian Code (Dev)" : "Meridian Code (Alpha)";
