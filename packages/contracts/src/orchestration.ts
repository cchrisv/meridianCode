...
import { CopilotModelOptions } from "./model";
import {
  ApprovalRequestId,
  CheckpointRef,
  CommandId,
...
export const ProviderKind = Schema.Literals(["copilot"]);
...
export const DEFAULT_PROVIDER_KIND: ProviderKind = "copilot";
...
export const ModelSelection = CopilotModelSelection;
