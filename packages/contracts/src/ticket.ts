...
export const TicketMetadata = Schema.Struct({
  ...
  workItemType: Schema.optional(TrimmedString),
  platform: Schema.optional(TrimmedString),
  team: Schema.optional(TrimmedString),
  priority: Schema.optional(TrimmedString),
  storyPoints: Schema.optional(Schema.Number),
  wsjfScore: Schema.optional(Schema.Number),
  areaPath: Schema.optional(TrimmedString),
  iterationPath: Schema.optional(TrimmedString),
  boardColumn: Schema.optional(TrimmedString),
  assignedTo: Schema.optional(TrimmedString),
});
...
export const TicketState = Schema.Struct({
  ...
  copilotPhase: Schema.optional(CopilotPhase),
  phasesCompleted: Schema.Array(CopilotPhase).pipe(Schema.withDecodingDefault(() => [])),
  contextPath: Schema.optional(TrimmedString),
